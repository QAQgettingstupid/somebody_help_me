...
public:
    ...
    //infile
    void in_name(string a);
    void in_price(int a);
    void in_ammount(int a);
...
void Merch::in_name(string a) {
    name = a;
}

void Merch::in_price(int a) {
    price = a;
}

void Merch::in_ammount(int a) {
    ammount = a;
}
